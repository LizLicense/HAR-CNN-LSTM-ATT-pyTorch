...
testAcc_csv=result_path+'result_cnn-lstm_HAPT_bef.csv'
f1_csv=result_path+'result_f1_HAPT_bef.csv'
confusion_img=result_path+'confusion matrix_HAPT_bef.png'
plot_img=result_path+'plot_cnn-lstm_HAPT_bef.png'
