...
data_folder = '../hhar_data/' #Change input data folder path
result = []
f1_result = []
classes = ['stand', 'sit', 'walk', 'stairsup', 'stairsdown', 'bike']

result_path='result/HHAR/CNNLSTM/'
testAcc_csv=result_path+'result_cnn-lstm_HHAR_pa_acc.csv'
f1_csv=result_path+'result_f1_HHAR_pa_acc.csv'
confusion_img=result_path+'confusion matrix_HHAR_pa_acc.png'
plot_img=result_path+'plot_cnn-lstm_HHAR_pa_acc.png'
...
def get_args():
    ...
    parser.add_argument('--lr', type=float, default=.00025) #0.0003
