...
data_folder = '../hapt_data/' #Change input data folder path
result = []
f1_result = []
...
result_path='result/HAPT/CNNLSTM/'
testAcc_csv=result_path+'result_cnn-lstm_HAPT.csv'
f1_csv=result_path+'result_f1_HAPT.csv'
confusion_img=result_path+'confusion matrix_HAPT.png'
plot_img=result_path+'plot_cnn-lstm_HAPT.png'
