...
data_folder = '../uci_data/rawdata/'#Change input data folder path
result = []
f1_result = []
classes = ['WALKING', 'WALKING_UPSTAIRS',  'WALKING_DOWNSTAIRS','SITTING', 'STANDING', 'LAYING']


result_path='result/UCI/CNNLSTMATT/'
testAcc_csv=result_path+'result_cnn-lstm-ATT_UCI.csv'
f1_csv=result_path+'result_f1-ATT_UCI.csv'
confusion_img=result_path+'confusion matrix_UCI-ATT.png'
plot_img=result_path+'plot_cnn-lstm-ATT_UCI.png'
