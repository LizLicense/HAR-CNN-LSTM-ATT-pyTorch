...
def load_data(data_folder):
    ...
    train_data = torch.load(data_folder + 'HHAR Processed Data/HHAR_p/accelerometer/train.pt')
    test_data = torch.load(data_folder + 'HHAR Processed Data/HHAR_p/accelerometer/test.pt')
